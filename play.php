...
curl_setopt($ch, CURLOPT_COOKIE, 'mac=00:1A:79:15:CB:57; stb_lang=en; timezone=GMT');
...
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
    ...
    // 'Cookie: mac=00:1A:79:15:CB:57; stb_lang=en; timezone=GMT'
));
...
$channelurl1=str_replace("http://hin2.error-404.website","http://195.181.169.66",$channelurl);
echo $channelurl1.'"';
curl_close($ch);
?>;
plyr.setup(video);
