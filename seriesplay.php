...
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'User-Agent: Mozilla/5.0 (QtEmbedded; U; Linux; C) AppleWebKit/533.3 (KHTML, like Gecko) MAG200 stbapp ver: 2 rev: 250 Safari/533.3',
    'X-User-Agent: Model: MAG250; Link: WiFi',
    'Referer: http://eurostar.mix.tm/sortby=addedstalker_portal/c/',
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,'http://eurostar.mix.tm/stalker_portal/server/load.php?type=vod&action=get_ordered_list&category='.$cat.'&movie_id='.$movieid.'&season_id='.$seasondid.'&episode_id='.$episodeid.'&p=1&sortby=added');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
    'User-Agent: Mozilla/5.0 (QtEmbedded; U; Linux; C) AppleWebKit/533.3 (KHTML, like Gecko) MAG200 stbapp ver: 2 rev: 250 Safari/533.3',
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,'http://eurostar.mix.tm/stalker_portal/server/load.php?type=vod&action=create_link&cmd=%2Fmedia%2Ffile_'.$json.'.mpg&series=');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
    'User-Agent: Mozilla/5.0 (QtEmbedded; U; Linux; C) AppleWebKit/533.3 (KHTML, like Gecko) MAG200 stbapp ver: 2 rev: 250 Safari/533.3',
